...
public enum QuestionCategory {
    ...
    /**
     * 신입 개발자의 기술적 성장, CS 기본기, 딥다이브형 학습
     * → RAG: description, techStack, rawContent 부스팅 (학습→적용 서사 중심)
     */
    GROWTH(
            "CS/딥다이브 기반 성장",
            "성장 경험, 자기 개발 중에서도 전공지식·기술적 깊이 탐구, 피드백 수용, 새로운 기술/CS 개념 습득과 실제 적용에 관련된 문항",
            List.of("성장", "학습", "CS", "운영체제", "자료구조", "알고리즘", "딥다이브", "기본기", "피드백", "개선")
    ),
