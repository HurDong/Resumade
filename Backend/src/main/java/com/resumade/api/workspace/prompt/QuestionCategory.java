...
public enum QuestionCategory {
    ...
    CULTURE_FIT(
            "조직문화·실행력·성격 적합성",
            "빠른 실행, MVP, 실험 문화, 고객 중심, 데이터 검증, 오너십, 회사 일하는 방식과의 적합성을 묻는 문항. 성격의 장단점, 자신의 가치관이나 일하는 스타일을 업무/프로젝트 맥락에서 묻는 문항도 포함",
            List.of("실행", "MVP", "가설", "실험", "A/B", "고객", "전환율", "오너십", "검증", "속도", "성격", "장단점", "강점", "약점", "스타일")
    ),
    ...
    TREND_INSIGHT(
            "기술/산업 인사이트",
            "최근 기술 동향, 산업/사회 이슈, 비즈니스 변화에 대한 견해와 이를 회사/직무와 연결하는 문항. AI/LLM 도구 활용 경험이나 견해를 묻는 문항도 포함",
            List.of("이슈", "트렌드", "동향", "산업", "AI", "클라우드", "보안", "플랫폼", "비즈니스", "견해", "LLM", "ChatGPT", "생성형")
    ),
