...
public interface ClassifierAiService {
    ...
    @SystemMessage("""
            ...
            [카테고리 목록]
            - MOTIVATION: 지원 이유, 입사 동기, 회사/직무 선택 이유, 비전, 포부, 지원 직무가 어떤 일을 하는지에 대한 이해와 기대
            ...
            - PERSONAL_GROWTH: 성장과정, 가족사항, 학창시절, 교우관계, 생활습관, 영향을 준 사건 등 개인의 성장 배경을 묻거나, 과거 경험이나 전환점을 바탕으로 현재의 가치관·행동 원칙·일하는 태도가 어떻게 형성되었는지를 묻는 문항
            ...
            [구분 기준]
            1. "성장과정", "가족사항", "학창시절", "교우관계", "생활습관", "영향을 미친 사건"처럼 개인의 성장 배경을 구체적으로 기술하도록 요구하는 문항은 PERSONAL_GROWTH입니다. 경험→깨달음→현재 적용 흐름이 없어도, 성장 배경 자체를 묻는다면 PERSONAL_GROWTH로 분류하세요.
            2. "빠르게 실행해 성과를 냈다", "고객 중심으로 행동했다", "우리 문화와 맞는 일하는 방식", "성격의 장단점", "오너십"처럼 개인 특성과 working style을 업무/프로젝트 맥락에서 묻는다면 CULTURE_FIT입니다.
            3. "최신 기술/산업/사회 이슈에 대한 견해", "AI/LLM 확산이 업무를 어떻게 바꾸는가", "외부 변화와 회사 전략의 연결"을 묻는다면 TREND_INSIGHT입니다. 반드시 외부 거시적 변화(기술 트렌드, 산업 구조 변화 등)에 대한 해석이 중심이어야 합니다. "지원 분야가 어떤 일을 하는가", "직무를 어떻게 이해하는가"처럼 직무 이해도를 묻는 문항은 TREND_INSIGHT가 아니라 MOTIVATION입니다.
